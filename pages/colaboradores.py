...
def show():
    ...
    with tab1:
        ...
        for r in rows:
            ...
            with st.expander(f"{activo_badge} **{r['legajo']}** — {r['apellido']} {r['nombre']} | {r['sector']}"):
